...
//CUTS
  ...
  TH1D *hq = new TH1D("q2", "Four momentum transfer squared", Bins, 0.0, Histo_xmax); 
  TH1D *hq2_qe = new TH1D("q2_qe", "Four momentum transfer squared in QE events", Bins, 0.0, Histo_xmax); 
  TH1D *hq2_res = new TH1D("q2_res", "Four momentum transfer squared in resonant events", Bins, 0.0, Histo_xmax);
  TH1D *hq2_mec = new TH1D("q2_mec", "Four momentum transfer squared in MEC events", Bins, 0.0, Histo_xmax);
  TH1D *hq2_dis = new TH1D("q2_dis", "Four momentum transfer squared in DIS events", Bins, 0.0, Histo_xmax);
    ...
    if (passescuts == true){
      cout << "passes" << endl;
        hEv -> Fill(Ev, weight);
             ...
             if(qel == true){
                 QESignalEvents += 1;
                 hq2_qe -> Fill(Q2, weight);
            }
    
             if(res == true){
                 RESSignalEvents += 1;
                 hq2_res -> Fill(Q2, weight);
              }
              if(mec == true){
                 hq2_mec -> Fill(Q2, weight);
             } 
             if(dis == true){
               DISSignalEvents += 1;
	             hq2_dis -> Fill(Q2, weight);
             }
    }
